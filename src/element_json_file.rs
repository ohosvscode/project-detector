...
use crate::element_json_file_name_reference::ElementJsonFileNameReference;
...
impl ElementJsonFile {
  ...
  #[napi]
  pub fn get_name_reference(&self, this: Reference<ElementJsonFile>, env: Env) -> Vec<ElementJsonFileNameReference> {
    Self::extract_name_references(&self.content, &this, env)
  }
}
